...
const Footer = () => {
  return (
    ...
    <div className="footerBox">
        <ul>
            <li className="title"><strong>TALLER PRIVADO</strong></li>
    ...
    <div className="footerBox">
        <ul>
            <li className="title"><strong>SEGUINOS</strong></li>
            <a className="igBox" href="https://www.instagram.com/lasortiz.flowerstore/"><i  id="igFooter" className="bi bi-instagram" ></i></a>
        </ul>
    </div>
    <div className="footerBox">
        <ul>
            <li className="title"> <strong>HORARIOS DE ATENCION</strong></li>
